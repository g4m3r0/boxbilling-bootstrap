    ...
    $('#optional_manage a').each(function(index, el) {
        ...
        if (href.indexOf('2031') !== -1) {
            ...
            $('#cwpanel_login_btn').click(function(event) {
                window.open("/wait.html",'cwpanel_window');
        ...
        if (href.indexOf('/cpanel') !== -1) {
            ...
            $(this).before(`
                    <form id="cwpanel_login" style="float:left;margin-right : 10px" target="cwpanel_window" action="`+ href +`/login/" method="post">
                        ...
                        <input type=button class='btn btn-primary' id="cwpanel_login_btn" value="Login to cPanel (your password will be changed)">
                    </form>
                    <a class="btn btn-primary" href="http://hera.24x7onlinedns.com/cpanel" target="_blank">Jump to cPanel</a>
